...
class Activity$ScreenCaptureCallback extends jni$_.JObject {
  ...
  void onScreenCaptured() {
    _onScreenCaptured(
      reference.pointer,
      _id_onScreenCaptured as jni$_.JMethodIDPtr,
    ).check();
  }
...
final class $Activity$ScreenCaptureCallback$NullableType
  ...
  Activity$ScreenCaptureCallback? fromReference(jni$_.JReference reference) =>
      reference.isNull
      ? null
      : Activity$ScreenCaptureCallback.fromReference(reference);
  @jni$_.internal
  @core$_.override
...
class Activity extends jni$_.JObject {
  ...
  void clearOverrideActivityTransition(int i) {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  jni$_.JObject? createPendingResult(int i, jni$_.JObject? intent, int i1) {
  ...
  int getLaunchedFromUid() {
    return _getLaunchedFromUid(
      reference.pointer,
      _id_getLaunchedFromUid as jni$_.JMethodIDPtr,
    ).integer;
  }
  ...
  bool onSearchRequested$1(jni$_.JObject? searchEvent) {
  ...
  void overrideActivityTransition(int i, int i1, int i2) {
  ...
  void overrideActivityTransition$1(int i, int i1, int i2, int i3) {
  ...
  void requestFullscreenMode(int i, jni$_.JObject? outcomeReceiver) {
  ...
  void requestOpenInBrowserEducation() {
    _requestOpenInBrowserEducation(
      reference.pointer,
      _id_requestOpenInBrowserEducation as jni$_.JMethodIDPtr,
    ).check();
  }
  ...
  static final _id_setAllowCrossUidActivitySwitchFromBelow = _class
  ...
  void setAllowCrossUidActivitySwitchFromBelow(bool z) {
  ...
  void setContentView(jni$_.JObject? view) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    _setContentView(
      reference.pointer,
  ...
  void setContentView$1(jni$_.JObject? view, jni$_.JObject? layoutParams) {
    final _$view = view?.reference ?? jni$_.jNullReference;
    final _$layoutParams = layoutParams?.reference ?? jni$_.jNullReference;
    _setContentView$1(
      reference.pointer,
  ...
  static final _id_setTitle = _class.instanceMethodId(r'setTitle', r'(I)V');
  ...
  static final _id_shouldShowRequestPermissionRationale$1 = _class
      .instanceMethodId(
        r'shouldShowRequestPermissionRationale',
  ...
  bool shouldShowRequestPermissionRationale$1(jni$_.JString? string, int i) {
    final _$string = string?.reference ?? jni$_.jNullReference;
